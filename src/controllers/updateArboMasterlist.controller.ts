 ...
 * @param {Response} res
 */
const updateArboMasterlistController = async (req: Request, res: Response): Promise<void> => {
  const masterlist = validationInput(updateArboMasterlistReqModel, req.body); // Handles validation and throws if needed
  ...
  await updateArboMasterlist(encryptData);
...
export default updateArboMasterlistController;
